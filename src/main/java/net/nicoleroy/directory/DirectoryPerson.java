...
public class DirectoryPerson {
	...
	/**
	 * @param eduPersonPrincipalName the eduPersonPrincipalName to set
	 */
	...
	/**
	 * @return the eduPersonNickname
	 */
	public String getEduPersonNickname() {
		return eduPersonNickname;
	}
	/**
	 * @param eduPersonNickname the eduPersonNickname to set
	 */
	public void setEduPersonNickname(String eduPersonNickname) {
